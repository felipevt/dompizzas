...
let routes = [{
    ...
    {
        path: '/autocomplete',
        component: require('./components/items/Autocomplete.vue').default
    },
    {
        path: '/produto',
        component: require('./components/Produto.vue').default
    },
    {
        path: '/cliente',
        component: require('./components/Cliente.vue').default
    },
    {
        path: '/items',
